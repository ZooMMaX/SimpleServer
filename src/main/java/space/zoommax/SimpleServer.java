...
import space.zoommax.next.ServerNext;
...
import space.zoommax.next.annotation.documentation.CreateDocumentation;
import space.zoommax.next.annotation.documentation.DocsGenerator;
import space.zoommax.next.enums.HttpMethod;
import space.zoommax.next.handlers.GetHandlerNew;
import space.zoommax.next.handlers.PostHandlerNew;
